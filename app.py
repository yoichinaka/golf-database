...
def create_app(test_config=None):
    ...
    def create_player(payload):
        ...
        try:
            ...
            added_id = Player.query.filter(
                Player.name == new_name).one_or_none()
    ...
    @app.route('/players/<int:player_id>/scores/<int:score_id>',
               methods=['DELETE'])
    @requires_auth('post_delete_update:score')
    ...
    def update_score(payload, player_id, score_id):
        ...
        try:
            ...
            score.update()
            return jsonify({'success': True, 'update coure_id, score, data': [
                           update_course_id, update_score, update_date], }), 200
        except BaseException:
            abort(422)
